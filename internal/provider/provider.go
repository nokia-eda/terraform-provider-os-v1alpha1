...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-os/internal/eda/utils"
...
var _ provider.Provider = (*osProvider)(nil)

func New(ver string) func() provider.Provider {
	return func() provider.Provider {
		return &osProvider{version: ver}
	}
}
...
func (p *osProvider) Schema(ctx context.Context, req provider.SchemaRequest, resp *provider.SchemaResponse) {
...
func (p *osProvider) Configure(ctx context.Context, req provider.ConfigureRequest, resp *provider.ConfigureResponse) {
...
func (p *osProvider) Metadata(ctx context.Context, req provider.MetadataRequest, resp *provider.MetadataResponse) {
	resp.TypeName = "os-v1alpha1"
	resp.Version = p.version
}

func (p *osProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		NewDeployImageDataSource,
		NewDeployImageListDataSource,
		NewWorkflowGetInputsRespElemDataSource,
	}
}

func (p *osProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		NewDeployImageResource,
	}
}
