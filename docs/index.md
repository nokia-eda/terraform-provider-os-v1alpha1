---
page_title: "os-v1alpha1 Provider"
---

# os-v1alpha1 Provider

This provider is used to interact with the resources provided by the **os-v1alpha1** application of the [Nokia EDA](https://docs.eda.dev) platform.
